  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/40 p-0 sm:p-4">
      <div className="w-full sm:max-w-md rounded-t-2xl sm:rounded-2xl bg-white dark:bg-zinc-900 shadow-xl p-6">
        ...
        <div className="mt-5 rounded-lg bg-zinc-100 dark:bg-zinc-800 p-4 text-center text-2xl tracking-widest font-mono">
        ...
        <button
          ...
          className="mt-4 w-full rounded-lg bg-zinc-900 dark:bg-zinc-100 dark:text-zinc-900 text-white py-2.5 font-medium hover:opacity-90 disabled:opacity-50"
        >
          {loadingNext ? "Loading…" : "Play again"}
        </button>
        <button
          onClick={share}
          className="mt-2 w-full rounded-lg border border-zinc-300 dark:border-zinc-700 py-2.5 font-medium hover:bg-zinc-50 dark:hover:bg-zinc-800"
        >
