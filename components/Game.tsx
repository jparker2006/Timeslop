  ...
  return (
    <div className="mx-auto w-full max-w-md px-4 pt-4 pb-12">
      <header className="mb-3 flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold tracking-tight">Timeslop</h1>
          <p className="text-xs text-zinc-500">order events on a timeline</p>
        </div>
        ...
        <section className="sticky top-0 z-10 -mx-4 px-4 pb-3 pt-2 bg-zinc-50/95 dark:bg-black/95 backdrop-blur">
          ...
          {phase === "feedback" && feedbackKind && (
            <div
              ...
              className={`rounded-lg border-2 px-3 py-3 text-center text-sm font-medium ${
          ...
          {phase === "done" && (
            <div className="rounded-lg border-2 border-zinc-300 dark:border-zinc-700 px-3 py-3 text-center text-sm">
              Done — {score}/{totalRounds} correct
            </div>
          )}
        </section>

        <p className="mt-4 mb-2 text-xs text-zinc-500">Timeline · oldest at top</p>
                  ...
                  {row.kind === "pending" ? (
                    <div>
                      ...
                      <button
                        ...
                        className="mt-2 w-full rounded-lg bg-zinc-900 dark:bg-zinc-100 dark:text-zinc-900 text-white py-2 text-sm font-medium hover:opacity-90"
                      >
                        Confirm placement
                      </button>
                    </div>
      ...
      {phase === "done" && !modalOpen && (
        <div className="mt-6 flex items-center justify-center gap-2">
          <button
            ...
            className="rounded-lg border border-zinc-300 dark:border-zinc-700 px-4 py-2.5 text-sm font-medium hover:bg-zinc-50 dark:hover:bg-zinc-800"
          >
            View result
          </button>
          <button
            ...
            className="rounded-lg bg-zinc-900 dark:bg-zinc-100 dark:text-zinc-900 text-white px-5 py-2.5 text-sm font-medium disabled:opacity-50"
          >
